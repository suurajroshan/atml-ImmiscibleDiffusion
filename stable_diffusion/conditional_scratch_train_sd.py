...
def main():
    ...
    # !!!!!!! For FT, comment everything about empty_unet !!!!!!!
    empty_unet = UNet2DConditionModel(cross_attention_dim=768)
    unet = UNet2DConditionModel.from_pretrained(
        args.pretrained_model_name_or_path, subfolder="unet", revision=args.non_ema_revision
    )
    unet.load_state_dict(empty_unet.state_dict())
    del empty_unet
    ...
    if args.use_ema:
        ...
        # clear the parameters in ema_unet to be the same as unet
        ema_unet.load_state_dict(unet.state_dict())
        # ema_unet = UNet2DConditionModel(cross_attention_dim=768)
    ...
    def tokenize_captions(examples, is_train=True):
        ...
        for caption in examples[caption_column]:
            ...
            captions.append(label_list[caption])

            # # This is for unconditional generation
            # captions.append('')

            # # This is for common text-to-image
